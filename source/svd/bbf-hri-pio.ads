...
package BBF.HRI.PIO is
   ...
   subtype PIOA_SCDR_DIV_Field is BBF.HRI.UInt14;
   ...
   subtype PIOA_WPMR_WPKEY_Field is BBF.HRI.UInt24;
   ...
   subtype PIOA_WPSR_WPVSRC_Field is BBF.HRI.UInt16;
